...
export default function DataListKv(props: { data: Record<string, boolean | string | { content?: string; detail?: string; render?: ReactNode; copy?: boolean }>; grid?: boolean; border?: boolean; className?: string }) {
	return (
